# AWS Deployment
Deploying the API expressjs consists of two steps: creating an Amazon Machine Image (AMI) with Packer and Ansible, and deploying that AMI to infrastructure using Terraform.
...
terraform apply \
    ...
    -var security_group=api-expressjs-security-group \
    -var rds_host=RDS_HOST \
    -var rds_password=RDS_PASSWORD \
    ...
    -var load_balancer_names=api-expressjs-lb \
